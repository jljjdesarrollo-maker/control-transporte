...
import { History, Pencil, Truck, Users, LogOut, User, FileText, Database, Download, Loader2, Share2, Settings } from 'lucide-react';
...
export function HomeScreen({ user, isAdmin, onGoToForm, onGoToHistory, onGoToPersonal, onGoToReports, onGoToConfig, onLogout, recordCount }: HomeScreenProps) {
          ...
          <>
            ...
            >
              <CardContent className="flex items-center gap-3 p-4">
                ...
                <div>
                  <p className="font-semibold text-[#3A3A3A]">Configuracion VT</p>
                  <p className="text-xs text-[#3A3A3A]/60">Frecuencias por unidad</p>
                </div>
              </CardContent>
            </Card>
